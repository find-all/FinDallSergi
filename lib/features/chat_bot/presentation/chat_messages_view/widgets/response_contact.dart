                        ...
                        children: [
                          Text(
                            companyName.isNotEmpty
                                ? companyName
                                : 'Nombre no disponible', // Verificación de valor vacío
                            style: TextStyle(
                              fontSize:
                                  fontSize + 2, // Título ligeramente más grande
                              fontWeight: FontWeight.bold,
                            ),
                            overflow: TextOverflow
                                .ellipsis, // Añadir puntos suspensivos
                            softWrap: false,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        phone.isNotEmpty
                            ? phone
                            : 'Teléfono no disponible', // Verificación de valor vacío
                        style: TextStyle(fontSize: fontSize),
                        overflow: TextOverflow
                            .ellipsis, // Añadir puntos suspensivos si el número es muy largo
                        softWrap: false,
                        maxLines: 1,
                      ),
                    ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        email.isNotEmpty
                            ? email
                            : 'Correo no disponible', // Verificación de valor vacío
                        style: TextStyle(fontSize: fontSize),
                        overflow: TextOverflow
                            .ellipsis, // Añadir puntos suspensivos para el correo
                        softWrap: false,
                        maxLines: 1,
                      ),
                    ),
